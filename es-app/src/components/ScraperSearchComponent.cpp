	...
	mSearchType(type)
{
	...
	mResultName = std::make_shared<TextComponent>(mWindow, "NOME", Font::get(FONT_SIZE_MEDIUM), 0x777777FF);
	...
	mResultDesc = std::make_shared<TextComponent>(mWindow, "DESCRIÇÃO", Font::get(FONT_SIZE_SMALL), 0x777777FF);
