...
GuiSlideshowScreensaverOptions::GuiSlideshowScreensaverOptions(Window* window, const char* title) : GuiScreensaverOptions(window, title)
{
	...
	addWithLabel(row, "TROCAR IMAGEM APÓS (SEGS)", sss_image_sec);
	...
	addWithLabel(row, "ESTICAR IMAGENS", sss_stretch);
	...
	addEditableTextComponent(row, "ÁUDIO DE FUNDO", sss_bg_audio_file, Settings::getInstance()->getString("SlideshowScreenSaverBackgroundAudioFile"));
	...
	addWithLabel(row, "USAR IMAGENS PERSONALIZADAS", sss_custom_source);
	...
	addEditableTextComponent(row, "DIRETÓRIO DAS IMAGENS PERSONALIZADAS", sss_image_dir, Settings::getInstance()->getString("SlideshowScreenSaverImageDir"));
	...
	addWithLabel(row, "DIRETÓRIO RECURSIVO DE IMAGEM PERSONALIZADA", sss_recurse);
	...
	addEditableTextComponent(row, "EXTENSÃO DAS IMAGENS", sss_image_filter, Settings::getInstance()->getString("SlideshowScreenSaverImageFilter"));
